...
async def version(ctx):
    ...
    embed = discord.Embed(
        title="SilverAutomation",
        description=f"Version: `{str(scriptVersion)}` \nOS: `{platform.system()}` (Windows) \nDebug Mode: `{debugIsEnabled}`",
        color=discord.Color.from_rgb(255, 182, 193)
    )
    embed.set_thumbnail(url="https://media.discordapp.net/attachments/1114312296039198774/1127971443053973685/IMG_0247.jpg?width=483&height=681")
    await ctx.send(embed=embed)
